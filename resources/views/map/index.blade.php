...
<body class="bg-slate-50">
    ...
    <div id="welcome-overlay" class="fixed inset-0 z-[9999] flex flex-col pointer-events-none overflow-hidden" style="display: none;">

        <!-- Top Half -->
        <div id="welcome-top" class="relative flex-1 bg-slate-900 pointer-events-auto transition-transform duration-[1200ms] ease-[cubic-bezier(0.87,0,0.13,1)] border-b border-white/5 shadow-2xl min-h-0 overflow-y-auto overflow-x-hidden flex flex-col justify-center">
            <div class="flex flex-col items-center text-center px-5 py-4 md:px-12 md:py-6 w-full max-w-3xl mx-auto gap-4">

                <!-- Title block: icon + name + subtitle -->
                <div class="flex flex-row items-center gap-3 md:gap-5">
                    <div class="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-2xl bg-sky-500/10 border border-sky-400/20 shrink-0">
                        <i class="fa-solid fa-map-location-dot text-xl sm:text-2xl md:text-2xl text-sky-400"></i>
                    </div>
                    <div class="text-left">
                        <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-white tracking-tight drop-shadow-md leading-tight">
                ...
                <div class="flex flex-row flex-wrap items-center justify-center gap-2 sm:gap-3">
                    <div class="flex flex-col items-center bg-white/5 px-3 sm:px-4 py-2 rounded-xl border border-white/10">
                    ...
                    <div class="flex items-center bg-white/5 rounded-xl border border-white/10">
                        <div class="flex flex-col items-center px-3 sm:px-4 py-2 border-r border-white/10">
                            <span class="text-base sm:text-lg md:text-xl font-bold text-rose-400">{{ $totalSd }}</span>
                            <span class="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">SD</span>
                        </div>
                        <div class="flex flex-col items-center px-3 sm:px-4 py-2 border-r border-white/10">
                            <span class="text-base sm:text-lg md:text-xl font-bold text-sky-400">{{ $totalSmp }}</span>
                            <span class="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">SMP</span>
                        </div>
                        <div class="flex flex-col items-center px-3 sm:px-4 py-2 border-r border-white/10">
                            <span class="text-base sm:text-lg md:text-xl font-bold text-amber-400">{{ $totalSma }}</span>
                            <span class="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">SMA</span>
                        </div>
                        <div class="flex flex-col items-center px-3 sm:px-4 py-2">
                            <span class="text-base sm:text-lg md:text-xl font-bold text-emerald-400">{{ $totalUniv }}</span>
                            <span class="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">Univ</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="welcome-center" class="h-[18vh] sm:h-[22vh] md:h-[30vh] shrink-0 relative flex items-center justify-center pointer-events-none transition-opacity duration-700 w-full bg-slate-800/60 backdrop-blur-[1px] border-y border-white/5">
            <div id="explore-btn-wrapper" class="pointer-events-auto z-10 transition-all duration-[1200ms] ease-[cubic-bezier(0.87,0,0.13,1)] scale-100">
                <button id="btn-explore-map" class="group relative px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 bg-sky-500 hover:bg-sky-400 text-white font-bold rounded-full text-sm sm:text-base md:text-lg shadow-[0_0_40px_rgba(14,165,233,0.6)] hover:shadow-[0_0_60px_rgba(14,165,233,0.8)] hover:-translate-y-1 transition-all duration-300 uppercase tracking-widest flex items-center gap-2 sm:gap-3">
        ...
        <!-- Bottom Half -->
        <div id="welcome-bottom" class="relative flex-1 bg-slate-900 pointer-events-auto transition-transform duration-[1200ms] ease-[cubic-bezier(0.87,0,0.13,1)] min-h-0 overflow-y-auto overflow-x-hidden flex flex-col justify-start xl:justify-center">

            <div class="w-full max-w-7xl mx-auto px-5 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-12 pt-5 md:pt-8 pb-2 shrink-0">

                <!-- About -->
                <div class="flex flex-col text-center">
                    <h3 class="text-white font-bold text-[11px] sm:text-sm uppercase tracking-wider mb-3 border-b border-white/10 pb-2 inline-block self-center">Tentang Aplikasi</h3>
                    <p class="text-[11px] sm:text-xs text-slate-400 leading-relaxed text-justify">
                        Platform GIS ini menyajikan pemetaan interaktif yang komprehensif, ditujukan secara khusus untuk manajemen fasilitas dan institusi pendidikan di wilayah Kota Blitar.
                    </p>
                </div>

                <!-- Features -->
                <div class="flex flex-col text-center">
                    <h3 class="text-white font-bold text-[11px] sm:text-sm uppercase tracking-wider mb-3 border-b border-white/10 pb-2 inline-block self-center">Fitur Unggulan</h3>
                ...
                <div class="flex flex-col text-center shrink-0">
                    <h3 class="text-white font-bold text-[11px] sm:text-sm uppercase tracking-wider mb-3 border-b border-white/10 pb-2 inline-block self-center">Pengembang</h3>
                    <p class="text-[11px] sm:text-xs text-slate-400 leading-relaxed mb-1">Dikembangkan oleh:</p>
                    <p class="text-[11px] sm:text-xs text-slate-300 font-medium mb-4">Rizqi Harisma | Choirul Ulum | Lovi Aldi</p>
            ...
            <div class="modal-card !w-[90vw] !max-w-[680px]">
                ...
                <div class="modal-body p-5 sm:p-6 max-h-[60vh] sm:max-h-[50vh] overflow-y-auto">
                    ...
                    <div class="border-t border-slate-100 pt-3.5 mb-3.5 grid grid-cols-2 gap-4 text-center">
                        ...
                        <div>
                            <span class="text-[13px] uppercase tracking-widest text-slate-400 block mb-1">Source Code</span>
                            <a href="https://github.com/rizHarism/gis-pendidikan" target="_blank" rel="noopener"
    ...
    <div id="detail-modal" class="modal-overlay"
         x-data="mapDetailModal()"
         :class="{ 'show': showDetail }"
         x-show="showDetail"
         @open-map-detail.window="openDetail($event.detail)"
         style="display: none;"
         x-cloak>
        ...
        <div class="modal-card !w-[96vw] !max-w-[680px]">
            ...
            <template x-if="!detailLoading && detail">
                <div class="flex flex-col h-full max-h-[88vh] sm:max-h-[85vh]">
                    ...
                    <div class="shrink-0 px-5 py-5 sm:py-8 md:py-10 flex items-start justify-between gap-3 rounded-t-2xl bg-gradient-to-br from-sky-700 to-slate-800">
                        <div class="flex-1 min-w-0">
                            <h2 class="text-lg font-black text-white leading-tight truncate" x-text="detail.name"></h2>
                            <div class="flex flex-wrap items-center gap-1.5 mt-1.5">
                                <span class="modal-jenjang-badge text-[10px] !px-2 !py-0.5" :class="badgeClass" x-text="jenjangLabel"></span>
                                <template x-if="detail.school_code">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-mono font-bold bg-white/20 text-white/90" x-text="'NPSN: ' + detail.school_code"></span>
                                </template>
                                <template x-if="detail.accreditation">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-black bg-white/20 text-white/90" x-text="'Akreditasi ' + detail.accreditation"></span>
                                </template>
                            </div>
                        </div>
                        <button @click="closeDetail()" class="shrink-0 w-8 h-8 flex items-center justify-center rounded-lg bg-white/20 hover:bg-white/30 text-white transition-colors" title="Tutup">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-3">
                            ...
                            <template x-if="detail.principal_name">
                                <div class="modal-info-row">
                                    ...
                                    <div>
                                        ...
                                        <div class="modal-info-value font-medium" x-text="detail.principal_name"></div>
                                    </div>
                                </div>
                            </template>
                                ...
                                <div class="modal-info-row">
                                    ...
                                    <div>
                                        ...
                                        <div class="modal-info-value">
                                            ...
                                            <template x-if="detail.student_capacity && detail.teacher_count"><span class="text-slate-300 mx-1">·</span></template>
                            ...
                            <template x-if="detail.phone">
                                <div class="modal-info-row">
                                    ...
                                    <div>
                                        ...
                                        <a :href="'tel:' + detail.phone" class="modal-info-value text-blue-600 hover:text-blue-800 hover:underline font-medium" x-text="detail.phone"></a>
                                    </div>
                                </div>
                            </template>
                            ...
                            <template x-if="detail.email">
                                <div class="modal-info-row">
                                    ...
                                    <div>
                                        ...
                                        <a :href="'mailto:' + detail.email" class="modal-info-value text-blue-600 hover:text-blue-800 hover:underline font-medium" x-text="detail.email"></a>
                                    </div>
                                </div>
                            </template>
                            ...
                            <template x-if="detail.website">
                                <div class="modal-info-row sm:col-span-2">
                                    ...
                                    <div>
                                        ...
                                        <a :href="detail.website" target="_blank" rel="noopener" class="modal-info-value text-blue-600 hover:text-blue-800 hover:underline break-all font-medium" x-text="detail.website"></a>
                                    </div>
                                </div>
                            </template>
                            ...
                            <template x-if="detail.opening_hours && detail.opening_hours.length > 0">
                                <div class="modal-info-row sm:col-span-2">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="modal-info-value space-y-1 mt-1 bg-slate-50 border border-slate-100 p-3 rounded-xl">
                                            <template x-for="(h, i) in detail.opening_hours" :key="i">
                                                <div class="flex justify-between items-center text-[12px]">
                                                    <span class="font-semibold text-slate-700" x-text="h.day"></span>
                                                    <span class="font-mono text-slate-500" x-text="h.open + ' – ' + h.close"></span>
                                                </div>
                                            </template>
                                        </div>
                                    </div>
                            ...
                            <template x-if="detail.description">
                                <div class="modal-info-row sm:col-span-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="modal-info-value text-slate-600 leading-relaxed" x-text="detail.description"></div>
                                    </div>
                                </div>
                            </template>
                            ...
                            <div class="modal-info-row sm:col-span-2">
                                ...
                                <div>
                                    ...
                                    <div class="modal-info-value modal-coords-text text-[11px] bg-slate-100 px-2 py-0.5 rounded-md inline-block mt-0.5" x-text="detail.latitude + ', ' + detail.longitude"></div>
                                </div>
                            </div>
                        </div>

                        {{-- ── Media Section (side-by-side grid) ── --}}
                        <template x-if="(detail.gallery && detail.gallery.length > 0) || (detail.video_url && ytEmbedUrl)">
                            <div class="mt-5 pt-5 border-t border-slate-100">
                                <div class="modal-info-label mb-3">Media</div>
                                        ...
                                        <div class="space-y-1.5">
                                            ...
                                            <div class="relative rounded-xl overflow-hidden bg-slate-100 aspect-video group">
                                                ...
                                                <template x-for="(img, idx) in detail.gallery" :key="idx">
                                                    <img :src="'/storage/' + img"
                                                         class="w-full h-full object-cover absolute inset-0 transition-transform duration-500 ease-in-out"
                                                         :class="{
                                                ...
                                                <template x-if="detail.gallery.length > 1">
                                                    <div class="absolute inset-0 z-10 pointer-events-none flex items-center justify-between px-1.5">
                                                        <button type="button" @click.stop="carouselIdx = carouselIdx === 0 ? detail.gallery.length - 1 : carouselIdx - 1"
                                                        ...
                                                        <button type="button" @click.stop="carouselIdx = (carouselIdx + 1) % detail.gallery.length"
                                                            class="w-7 h-7 pointer-events-auto bg-black/40 hover:bg-black/70 text-white rounded-full flex items-center justify-center transition-colors opacity-70 hover:opacity-100">
                                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                                        </button>
                                                    </div>
                                                </template>
                                                <span class="absolute bottom-1.5 right-2 z-10 bg-black/60 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full"
                                    ...
                                    <template x-if="detail.video_url && ytEmbedUrl">
                                        <div class="space-y-1.5">
                                            ...
                                            <template x-if="!showVideo">
                                                <button type="button" @click="showVideo = true" class="w-full relative rounded-xl overflow-hidden group aspect-video block border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                                                    ...
                                                    <div class="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition-colors flex items-center justify-center">
                                                        <div class="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform">
                                            ...
                                            <template x-if="showVideo">
                                                <div class="rounded-xl overflow-hidden aspect-video border border-slate-200 shadow-sm bg-black">
                                                    <iframe :src="ytEmbedUrl" class="w-full h-full" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                </div>
                                            </template>
                                        </div>
                                    </template>
                ...
                async openDetail(facilityId) {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            if (m === 'sd') {
                                config = { label: "SD", badgeClass: "bg-rose-100 text-rose-800" };
                            } else if (m === 'smp') {
                                config = { label: "SMP", badgeClass: "bg-sky-100 text-sky-800" };
                            } else if (m === 'sma') {
                                config = { label: "SMA", badgeClass: "bg-amber-100 text-amber-800" };
                            } else if (m === 'universitas') {
                                config = { label: "Universitas", badgeClass: "bg-emerald-100 text-emerald-800" };
                            }
