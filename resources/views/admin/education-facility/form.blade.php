                    ...
                    <div class="bg-white dark:bg-slate-800 p-8 rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm space-y-5">
                        <div class="grid grid-cols-1 gap-5">
                            ...
                            <div x-data="{ 
                                ...
                                <label for="image" class="block text-xs font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">Foto Fasilitas</label>
                                <div class="mt-1 flex flex-col items-center justify-center border-2 border-slate-200 dark:border-slate-600 border-dashed rounded-2xl bg-slate-50/50 dark:bg-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors overflow-hidden relative group min-h-[160px]">
                                    <!-- Image Preview -->
